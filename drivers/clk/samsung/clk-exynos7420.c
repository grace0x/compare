...
enum exynos7420_clks {
	...
	aclk_lh_vpp1, d_pclk_vpp, pclk_vpp, vpp_last = 599,
...
static struct samsung_gate exynos7420_gate_clks[] __initdata = {
	...
	GATE(none, "aclk_smmu_vpp_sfw1", "usermux_aclk_vpp0_400", \
	...
	GATE(none, "aclk_smmu_vpp_sfw0", "usermux_aclk_vpp0_400", \
	...
	GATE(none, "pclk_smmu_vpp_sfw0", "dout_pclk_vpp_133", \
	...
	GATE(none, "pclk_smmu_vpp_sfw1", "dout_pclk_vpp_133", \
